 ...
 * 2016-11-11T15:32:25.017+01:00
 * Generated source version: 2.5.1
 * 
 */
@WebServiceClient(name = "NotificationService", 
                  wsdlLocation = "file:/C:/Users/MFIORELLO00/AnypointStudio/workspace/basicapp/wfoutbound.wsdl",
...
public class NotificationService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/MFIORELLO00/AnypointStudio/workspace/basicapp/wfoutbound.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(NotificationService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/MFIORELLO00/AnypointStudio/workspace/basicapp/wfoutbound.wsdl");
        }
        WSDL_LOCATION = url;
    }
