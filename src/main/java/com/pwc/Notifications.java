 ...
 *         &lt;element name="Notification" type="{http://soap.sforce.com/2005/09/outbound}AccountNotification" maxOccurs="100"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Notifications {
    ...
    protected List<AccountNotification> notification;
    ...
    public List<AccountNotification> getNotification() {
        if (notification == null) {
            notification = new ArrayList<AccountNotification>();
        }
